...
{
    i2c1_error_t returnValue = I2C1_BUSY; //I2C1_BUSY=1
    
    if(!I2C1_Status.inUse) //inUse一開始是0
    {
        I2C1_Status.address = address;
        I2C1_Status.busy = 0;
        I2C1_Status.inUse = 1; //進來之後讓他變成1，之後就不進if了，而且i2c也開好了
        ...
        // set all the call backs to a default of sending stop  //讓所有回傳的值設為停止的默認值
        ...
        returnValue = I2C1_NOERR;     //I2C1_NOERR=0
    }
