...
typedef enum {
    I2C1_NOERR, // The message was sent.                      //=0
    I2C1_BUSY,  // Message was not sent, bus was busy.        //=1
    I2C1_FAIL   // Message was not sent, bus failure          //=2
...
typedef uint8_t i2c1_address_t; //定義 i2c1_address_t 一定是 uint8_t
typedef i2c1_operations_t (*i2c1_callback_t)(void *funPtr);  //i2c1_callback_t callbackTable[6]
